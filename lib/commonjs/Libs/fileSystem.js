...
exports.FileSystemManager = exports.FileBucket = void 0;
var _reactNativeBlobUtil = _interopRequireDefault(require("react-native-blob-util"));
var _util = require("../Utils/util");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
// RNFS
const FSManager = _reactNativeBlobUtil.default.fs;
//
let FileBucket = exports.FileBucket = /*#__PURE__*/function (FileBucket) {
...
class FileSystemManager {
  ...
  async copyfile(fromPath, toBucket) {
    if (fromPath) {
      const fileExtension = (0, _util.getExtensionIfNeed)(fromPath, null);
