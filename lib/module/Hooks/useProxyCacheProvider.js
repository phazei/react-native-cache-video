 ...
 *  "
 */
export const CacheManagerContext = /*#__PURE__*/createContext({
...
export const CacheManagerProvider = ({
  ...
  const cacheManager = useRef(new CacheManager('react-native-cache-video', devMode));
  //
  ...
  const notifyEvent = useCallback(runningPort => {
  ...
  return /*#__PURE__*/React.createElement(CacheManagerContext.Provider, {
    value: {
